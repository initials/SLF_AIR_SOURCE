package org.flixel
{
	...
	public class FlxG
	{
		...
		static public function overlapWithOffset(ObjectOrGroup1:FlxBasic=null,ObjectOrGroup2:FlxBasic=null,offsetX:Number=0, offsetY:Number=0, NotifyCallback:Function=null,ProcessCallback:Function=null):Boolean
		{
			if(ObjectOrGroup1 == null)
				ObjectOrGroup1 = FlxG.state;
			if(ObjectOrGroup2 === ObjectOrGroup1)
			...
			var quadTree:FlxQuadTree = new FlxQuadTree(FlxG.worldBounds.x,FlxG.worldBounds.y,FlxG.worldBounds.width,FlxG.worldBounds.height,null,offsetX,offsetY);
			//trace(quadTree._offsetX);
		...
		static internal function init(Game:FlxGame,Width:uint,Height:uint,Zoom:Number):void
		{
			...
			if(joyPrefs.bind("flixel") && (joyPrefs.data != null))
			{
				if(joyPrefs.data.usingJoystick != null)
					FlxG.usingJoystick = joyPrefs.data.usingJoystick;
				else
			...
			if (FlxG.usingJoystick)
				...
				FlxG.joystick = new FlxJoystickEmpty();
		...
		public function showPauseGraphic():void {
			_game._focus.visible = true;
		}
		
		public function hidePauseGraphic():void {
			_game._focus.visible = false;
		}		
