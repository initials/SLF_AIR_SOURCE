package org.flixel.system
{
	...
	public class FlxQuadTree extends FlxRect
	{
		 ...
		 */
		public function FlxQuadTree(X:Number, Y:Number, Width:Number, Height:Number, Parent:FlxQuadTree=null, offsetX:Number=0, offsetY:Number=0)
		{
		...
		protected function addObject():void
		{
			...
			if((_objectLeftEdge > _leftEdge) && (_objectRightEdge < _midpointX))
			{
				...
				{
					if(_northWestTree == null)
						_northWestTree = new FlxQuadTree(_leftEdge,_topEdge,_halfWidth,_halfHeight,this,_offsetX,_offsetY);
				...
				{
					if(_southWestTree == null)
						_southWestTree = new FlxQuadTree(_leftEdge,_midpointY,_halfWidth,_halfHeight,this,_offsetX,_offsetY);
			...
			if((_objectLeftEdge > _midpointX) && (_objectRightEdge < _rightEdge))
			{
				...
				{
					if(_northEastTree == null)
						_northEastTree = new FlxQuadTree(_midpointX,_topEdge,_halfWidth,_halfHeight,this,_offsetX,_offsetY);
				...
				{
					if(_southEastTree == null)
						_southEastTree = new FlxQuadTree(_midpointX,_midpointY,_halfWidth,_halfHeight,this,_offsetX,_offsetY);
		...
		protected function overlapNode():Boolean
		{
			...
			while(_iterator != null)
			{
				...
				if(	(_objectHullX  + _objectHullWidth > _checkObjectHullX - _offsetX  ) &&
					(_objectHullX  < _checkObjectHullX + _checkObjectHullWidth + _offsetX) &&
					(_objectHullY  + _objectHullHeight > _checkObjectHullY - _offsetY) &&
					(_objectHullY  < _checkObjectHullY + _checkObjectHullHeight + _offsetY) )
				{
